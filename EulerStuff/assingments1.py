...
""" Exercise 1:Multiples of 3 and 5(from EulerStuff 1)If we list all the natural numbers
...
"""Exercise 4:Fibonacci(from EulerStuff 2)Each new term in the Fibonacci sequence is generated by adding the previous 
...
"""Exercise 5:Palindromes(from EulerStuff 4)A palindromic number reads the same both ways.  
...
"""Exercise 8:(Largest prime factorsfrom EulerStuff 3)
...
"""Exercise 9:(Optional) Divisors(from EulerStuff 5) 2520 is the smallest number that can be divided by each 
...
if __name__ == '__main__':
    ...
    print(convert(35, 16, "LIVE4OTHERS"))
    print(convert(16, 12, "3C64EB0"))
